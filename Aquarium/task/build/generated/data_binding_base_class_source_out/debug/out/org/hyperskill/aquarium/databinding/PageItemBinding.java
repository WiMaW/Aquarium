...
public final class PageItemBinding implements ViewBinding {
  ...
  private PageItemBinding(@NonNull FrameLayout rootView, @NonNull CardView cardView,
  ...
  public static PageItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new PageItemBinding((FrameLayout) rootView, cardView, imageView, scrollView,
